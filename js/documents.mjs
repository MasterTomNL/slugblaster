...
export class SlugblasterActor extends Actor {
  ...
  async _onCreate(data, options, userId) {
    ...
    // for crew actors, add fame details
    if (data.type == 'crew') {
      // 0. Nobodies: Compendium.world.playbooks.Actor.XVd6GmJNUV9eLD6B
      // 1. Up & Comers: Compendium.world.playbooks.Actor.iiXO7VDJGZZBXuMT
      // 2. Well-Established: Compendium.world.playbooks.Actor.hlfLZWXOpm239DMX
      // 3. Major Players: Compendium.world.playbooks.Actor.9t8UtlGk3NfV1Yt3
      // 4. Rising Stars: Compendium.world.playbooks.Actor.uaeJoZB049AlFI4C
      // 5. Legends: Compendium.world.playbooks.Actor.PkGUg3J4qF2XtXEl
    }
