export class SlugblasterFameSheet extends ActorSheet {
  get template() {
    return 'systems/slugblaster/template/fame-sheet.hbs';
  }
  ...
  async _onAdd(event) {
    ...
    await Item.create({ name: game.i18n.localize('SB.newPerk'), type: type }, { parent: this.actor });
  }
