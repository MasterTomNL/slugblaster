...
export class SlugblasterActorData extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      boostsRemaining: new NumberField({ required: true, integer: true, min: -1, max: 9, initial: 0 }),
      kicksRemaining: new NumberField({ required: true, integer: true, min: -1, max: 9, initial: 0 }),
